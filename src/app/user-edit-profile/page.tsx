  ...
  return (
    <main>
      ...
      <div className="flex mt-3 mb-2">
        <button className="ml-2 font-sans">
          <Link href="/user-home">Back</Link>
        </button>
      ...
      <figure className="md:flex w-auto mt-5 ml-2">
        ...
        <div className="mt-18 text-base pl-10 gap-1 content-start">
          ...
          <button className="mt-5 bg-blue-500 hover:bg-blue-700 border-none text-white text-center flex items-center px-4 py-2 rounded">
            Delete Photo
          </button>
        </div>
      </figure>
      <div className="font-sans ml-4 mt-4 mb-5 tracking-wide">
        ...
        <div className="flex bottom-0 right-0">
          <button className="mt-5 bg-blue-500 hover:bg-blue-700 border-none text-white flex items-center px-2 py-2 rounded">
            Save
          </button>
        </div>
      </div>
