...
function UserRegister(){
    ...
    return(
        <form onSubmit = {handleSubmit}>
            ...
            <div className = "mt-10 mb-6 ml-9 flex">
                <button type = "submit" className = "mt-5 bg-blue-500 hover:bg-blue-700 border-none text-white text-center flex items-center px-4 py-2 rounded mb-2">Submit</button>
            </div>
        </form>
    );
}
